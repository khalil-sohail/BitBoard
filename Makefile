...
SRCS = src/*.cpp src/eval/*.cpp src/search/*.cpp src/move/*.cpp
ENGINE_SRCS = src/Board.cpp src/generateAllMoves.cpp src/printers.cpp src/eval/*.cpp src/search/*.cpp src/move/*.cpp
